...
prodigydiv.innerHTML = '<a href="javascript:prodigydiv.remove();"> <font color="red">|Close|</font> </a> <a href="javascript:window.PIXI.game.prodigy.user.source.data.level=100"><font color="red">|Level 100 Player|</font><a href="javascript:window.PIXI.game.prodigy.user.source.data.level=75"><font color="red">|Level 75 Player|</font><a href="javascript:window.PIXI.game.prodigy.user.source.data.level=50"><font color="red">|Level 50 Player|</font><a href="javascript:window.PIXI.game.prodigy.user.source.data.level=25"><font color="red">|Level 25 Player|</font></a><a href="javascript:FreeMembership();"> <font color="red">|Free Membership|</font> </a> <a href="javascript:PIXI.game.prodigy.debugMisc.smallLoan(1000000);"><font color="red"> |1,000,000 Coins|</font> </a><a href="javascript:PIXI.game.prodigy.debugMisc.getAllPets();"><font color="red">|Get All Pets|</font></a> <a href="javascript:PIXI.game.prodigy.player.backpack.data.item.push({"N":Infinity,"ID":130});"> <font color="red">|Infinite Wheel Spins|</font></a><a href="javascript:FreeAtSchool()"><font color="red"> |Unlock All Zones|</font></a><a href="javascript:levelUpPets()"><font color="red"> |Level 100 Pets|</font></a><a href="javascript:getallFollow()"> <font color="red">|Get All Buddies|</font></button><a href="javascript:getallItem()"> <font color="red">|Get All Items|</font></a><a href="javascript:getallCurrency()"> <font color="red">|Get All Currencies|</font></a><p><font color="purple">Made By GameHackerC!</font></p>';
alert("God Mode Hack INJECTED")
alert("Thank You For Using GameHackerC's Prodigy God Mode Hack!")
javascript:!function(){var checkKeyPressed=e=>{console.log(e.key),
"a"==e.key&&solve(document.querySelector(".questions-text-alignment").childNodes[0].data+"x"+document.querySelector
(".questions-text-alignment").childNodes[2].data)};function solve(func){var out=document.querySelector
(".questions-input-adjustment");if(console.log(out),"H"!=func[1]){func=func.replace("%C3%97","*"),
